...
class IndianTaxCalculator:
    ...
    def compare_and_optimize(
        ...
        """
        old = self.calculate_old_regime_tax(gross_income, deductions)
        new = self.calculate_new_regime_tax(gross_income)
        ...
        tips = self._generate_tips(gross_income, deductions, old, new, recommended)

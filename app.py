...
if twin:
    ...
    info_html = f'<div class="info-card success"><span class="info-icon"><i class="fa-solid fa-circle-user" style="vertical-align:middle; color:#22C55E; font-size:1.25rem;"></i></span><span class="info-text">Welcome back, <strong>{_he(twin.name)}</strong>! Your Financial Digital Twin is active.</span></div>'
else:
    kpis = [
    ...
    info_html = '<div class="info-card"><span class="info-icon"><i class="fa-solid fa-lock" style="vertical-align:middle; color:#94A3B8; font-size:1.25rem;"></i></span><span class="info-text">Sign in or register via the sidebar to unlock personalized financial insights and AI predictions.</span></div>'
...
.hero-container {{ animation: fadeInSection 0.6s cubic-bezier(0.16, 1, 0.3, 1) forwards; }}
.info-card {{ animation: fadeInSection 0.6s cubic-bezier(0.16, 1, 0.3, 1) 0.1s forwards; opacity: 0; }}
.kpi-grid {{ animation: fadeInSection 0.6s cubic-bezier(0.16, 1, 0.3, 1) 0.2s forwards; opacity: 0; }}
.module-section-title {{ animation: fadeInSection 0.6s cubic-bezier(0.16, 1, 0.3, 1) 0.3s forwards; opacity: 0; }}
.module-grid {{ animation: fadeInSection 0.6s cubic-bezier(0.16, 1, 0.3, 1) 0.4s forwards; opacity: 0; }}
.features-section-title {{ animation: fadeInSection 0.6s cubic-bezier(0.16, 1, 0.3, 1) 0.5s forwards; opacity: 0; }}
.features-grid {{ animation: fadeInSection 0.6s cubic-bezier(0.16, 1, 0.3, 1) 0.6s forwards; opacity: 0; }}
...
<div class="module-section-title" style="margin-top: 2rem; margin-bottom: 0.5rem;">
    <h3 style="color: #F8FAFC; font-weight: 600; font-size: 1.25rem; letter-spacing: -0.01em;">Platform Modules</h3>
</div>
...
<div class="module-grid">
    ...
    <div class="module-card">
        ...
        <div class="module-desc">Plan savings goals and track long-term progress.</div>
    </div>
    <div class="module-card">
        <div class="module-icon"><i class="fa-solid fa-brain" style="color:#E2E8F0; font-size: 2.2rem;"></i></div>
...
<div class="features-section-title" style="margin-top: 3rem; margin-bottom: 0.5rem;">
    <h3 style="color: #F8FAFC; font-weight: 600; font-size: 1.25rem; letter-spacing: -0.01em;">Why Choose FinTwin AI</h3>
</div>
